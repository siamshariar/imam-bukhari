...
export default function MembersList({ teachers }) {
  return (
    <>
      <Meta
          title="একাডেমিক কমিটির সদস্যবৃন্দ"
        description="একাডেমিক কমিটির সম্মানিত সদস্যবৃন্দ কুল্লিয়াতুল কুরআনিল কারীম ওয়াদ-দিরাসাতিল ইসলামিয়্যাহ"
